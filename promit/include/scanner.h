...
typedef enum {
	...
	TOKEN_RIGHT_SHIFT, TOKEN_LEFT_SHIFT,
	...
	TOKEN_INTERPOLATION_START, TOKEN_INTERPOLATION_END, TOKEN_CONTINUE,
	TOKEN_GLOBAL_INTERPOLATION, TOKEN_DEL, TOKEN_LEFT_SQUARE, TOKEN_RIGHT_SQUARE,

	TOKEN_IF, TOKEN_ELSE, TOKEN_TRUE, TOKEN_FALSE,
	TOKEN_CLASS, TOKEN_THIS, TOKEN_NULL, TOKEN_FUNCTION,
   	TOKEN_SHOW, TOKEN_RECIEVE, TOKEN_FOR, TOKEN_WHILE, 
	TOKEN_SUPER, TOKEN_TAKE, TOKEN_RETURN, TOKEN_SHOWL,
	TOKEN_CONST, TOKEN_TYPEOF, TOKEN_DO, TOKEN_BREAK, TOKEN_INSTOF, 
