...
/**
 * This version of dtoa is customized for Project Promit. Please do not 
 * use it except upmost necessity.
 */
...
// Extra added in Project Promit.

#define IEEE_8087 1
#define Honor_FLT_ROUNDS 1
#define Omit_Primitive_Memory 1
#define NO_INFNANCHECK 1
#define NO_HEX_FP 1
